...
sort -k5,5 $DATA_PATH/check_seq/master_file/allsample_data_merge.tsv > $DATA_PATH/check_seq/master_file/allsample_data_merge_sort.tsv
paste $DATA_PATH/check_seq/master_file/allsample_data_merge_sort.tsv $DATA_PATH/check_seq/bwa/result/mapping_info_sort > $DATA_PATH/check_seq/master_file/allsample_ERVinfo_master.txt
