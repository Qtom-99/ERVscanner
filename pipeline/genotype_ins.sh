...
python3 $PY_PATH/extract_sample_pos.py ${line} $DATA_PATH/01table/allsample_01table_filtered.tsv $DATA_PATH/allsample_merge/pos.bed $DATA_PATH/sampledata/${line}/clip/${line}_pos.bed
