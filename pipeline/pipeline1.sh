...
bedtools pairtobed -type xor -abam $DATA_PATH/sampledata/${line}/${line}_dfamallhit_overlap_F256_F2048_sortn.bam -b $QUERY_BED_FULLPATH 2>/dev/null > /media/fujiwara/WD181PURP18Tb/yano24_08/mouse/benchmark/yano/5reads_q30/sampledata/JF1_cov30_reheader/${line}_dfamallhit_overlap_F256_F2048_sortn_xor.bam
bedtools bamtobed -i /media/fujiwara/WD181PURP18Tb/yano24_08/mouse/benchmark/yano/5reads_q30/sampledata/JF1_cov30_reheader/${line}_dfamallhit_overlap_F256_F2048_sortn_xor.bam > $DATA_PATH/sampledata/${line}/${line}_dfamallhit_overlap_F256_F2048_sortn_xor.bed
...
samtools view -@ $NCORE -N $DATA_PATH/sampledata/${line}/${line}_readname_nonread_uniq.txt -o $DATA_PATH/sampledata/${line}/${line}_dfamallhit_overlap_F256_F2048_sortn_xor_discordant.bam /media/fujiwara/WD181PURP18Tb/yano24_08/mouse/benchmark/yano/5reads_q30/sampledata/JF1_cov30_reheader/${line}_dfamallhit_overlap_F256_F2048_sortn_xor.bam
...
ython3 $DATA_PATH/script/extract_altxahit.py $DATA_PATH/sampledata/${line}/curated_bam/${line}_dfamallhit_ERV_bed_position_F256_F2048_sortn_xor_discordant_onlyf8_sort_q${QUALITY}.bam $DATA_PATH/sampledata/${line}/curated_bam/${line}_dfamallhit_ERV_bed_position_F256_F2048_sortn_both_discordant_onlyf8_sort_q${QUALITY}_noalt.bam $DATA_PATH/sampledata/${line}/curated_bam/${line}_dfamallhit_ERV_bed_position_F256_F2048_sortn_both_discordant_onlyf8_sort_q${QUALITY}_remove.bam $ALT_CHR_LIST
...
bedtools intersect -a /media/fujiwara/WD181PURP18Tb/yano24_08/mouse/benchmark/yano/5reads_q30/sampledata/JF1_cov30_reheader/${line}_dfamallhit_overlap_F256_F2048_sortn_xor.bam -b $QUERY_BED_FULLPATH -v > $DATA_PATH/sampledata/${line}/read_info/${line}_ERVposition.bam
...
bedtools intersect -a /media/fujiwara/WD181PURP18Tb/yano24_08/mouse/benchmark/yano/5reads_q30/sampledata/JF1_cov30_reheader/${line}_dfamallhit_overlap_F256_F2048_sortn_xor.bam -b $QUERY_BED_FULLPATH -wa > $DATA_PATH/sampledata/${line}/read_info/${line}_ERVread.bam
